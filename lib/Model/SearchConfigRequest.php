 ...
 */
class SearchConfigRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'searchConfigRequest';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('config_schema', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets tenant_id
     *
     * @param string|null $tenant_id tenant_id for which create or update indexes configuration [#DOCGENBUG REQUIRED FIELD]
     *
     * @return self
     */
    ...
    {
        if (is_null($config_schema)) {
            throw new \InvalidArgumentException('non-nullable config_schema cannot be null');
        }
