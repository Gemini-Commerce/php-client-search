 ...
 */
class SearchWriteResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'searchWriteResponse';
    ...
    */
     ...
     * Sets index
     *
     * @param string $index elasticsearch index where the write request was processed
     *
     * @return self
     */
