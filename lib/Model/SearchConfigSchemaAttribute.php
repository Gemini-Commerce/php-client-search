 ...
 */
class SearchConfigSchemaAttribute implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'searchConfigSchemaAttribute';
    ...
    */
     ...
     * Sets language
     *
     * @param string|null $language locale code (currently only it_IT and en_US are supported)
     *
     * @return self
     */
