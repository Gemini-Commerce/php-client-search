...
/**
 * SearchConfigSchemaSearchable Class Doc Comment
 *
 * @category Class
 * @description contains the configurations needed to define which index attributes can be used for search
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SearchConfigSchemaSearchable implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'searchConfigSchemaSearchable';
    ...
    */
     ...
     * Sets attribute
     *
     * @param string $attribute json array of attributes of index which can be used for search
     *
     * @return self
     */
