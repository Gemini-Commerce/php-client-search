 ...
 */
class SearchParamFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'searchParamFilter';
    ...
    */
     ...
     * Sets filter
     *
     * @param string $filter JSON string that contains filters information to apply to search
     *
     * @return self
     */
