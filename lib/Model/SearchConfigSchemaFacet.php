...
/**
 * SearchConfigSchemaFacet Class Doc Comment
 *
 * @category Class
 * @description contains the configurations needed to define an aggregation (Facet) using defined index attributes
 * @package  GeminiCommerce\Search
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SearchConfigSchemaFacet implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'searchConfigSchemaFacet';
    ...
    */
     ...
     * Sets attribute
     *
     * @param string $attribute json array of attributes of index that you can use as aggregation to make facets
     *
     * @return self
     */
