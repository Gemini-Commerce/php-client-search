...
/**
 * SearchDeleteRequest Class Doc Comment
 *
 * @category Class
 * @package  GeminiCommerce\Search
 * @author   OpenAPI Generator team
 ...
 */
class SearchDeleteRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'searchDeleteRequest';
    ...
    */
     ...
     * Sets tenant_id
     *
     * @param string|null $tenant_id tenant_id for which remove costraints [#DOCGENBUG REQUIRED FIELD]
     *
     * @return self
     */
     ...
     * Sets constraints
     *
     * @param \GeminiCommerce\Search\Model\SearchDeleteConstraints[]|null $constraints constraints to remove (index name) [#DOCGENBUG REQUIRED FIELD]
     *
     * @return self
     */
