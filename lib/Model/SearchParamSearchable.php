...
/**
 * SearchParamSearchable Class Doc Comment
 *
 * @category Class
 ...
 */
class SearchParamSearchable implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'searchParamSearchable';
    ...
    */
     ...
     * Sets attribute
     *
     * @param string $attribute JSON string that contains the list of attributes where to search the indicated term
     *
     * @return self
     */
