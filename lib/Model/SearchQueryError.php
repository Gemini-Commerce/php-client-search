...
/**
 * SearchQueryError Class Doc Comment
 *
 * @category Class
 ...
 */
class SearchQueryError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'searchQueryError';
    ...
    */
     ...
     * Sets code
     *
     * @param string $code query error code obtained during elastic search query request
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string $message query error message obtained during elastic search query request
     *
     * @return self
     */
