 ...
 */
class SearchParamFacet implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'searchParamFacet';
    ...
    */
     ...
     * Sets attribute
     *
     * @param string $attribute JSON string that contains the list of attributes you want to create aggregation to make filter suggestion
     *
     * @return self
     */
     ...
     * Sets limit
     *
     * @param int|null $limit Limit of facets result
     *
     * @return self
     */
