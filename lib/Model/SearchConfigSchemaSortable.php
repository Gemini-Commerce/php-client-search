...
/**
 * SearchConfigSchemaSortable Class Doc Comment
 *
 * @category Class
 * @description contains the configurations needed to define which index attributes can be used for sort
 * @package  GeminiCommerce\Search
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SearchConfigSchemaSortable implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'searchConfigSchemaSortable';
    ...
    */
     ...
     * Sets attribute
     *
     * @param string $attribute json array of attributes of index which can be used for sort
     *
     * @return self
     */
