 ...
 */
class SearchParamSort implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'searchParamSort';
    ...
    */
     ...
     * Sets attribute
     *
     * @param string $attribute JSON string that contains the list of attributes you want search results to be ordered by
     *
     * @return self
     */
