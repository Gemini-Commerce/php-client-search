...
/**
 * SearchWriteRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class SearchWriteRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'searchWriteRequest';
    ...
    */
     ...
     * Sets tenant_id
     *
     * @param string|null $tenant_id tenant id data identifier where to write data [#DOCGENBUG REQUIRED FIELD]
     *
     * @return self
     */
     ...
     * Sets index
     *
     * @param string $index elasticsearch index identifier where to write data
     *
     * @return self
     */
     ...
     * Sets documents
     *
     * @param string[] $documents A JSON array of documents to write or update
     *
     * @return self
     */
