...
/**
 * SearchParamAttribute Class Doc Comment
 *
 * @category Class
 * @description contains a list of document attributes which you want the search returns
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SearchParamAttribute implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'searchParamAttribute';
    ...
    */
     ...
     * Sets attribute
     *
     * @param string $attribute JSON string that contains the list of attributes you want to be returned in search results
     *
     * @return self
     */
